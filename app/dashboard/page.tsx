      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="max-w-md w-full">
              <EnhancedSearch
                ...
                placeholder="Search cryptocurrency, contract, or address..."
                className="w-full"
              />
            </div>
          </div>
          ...
          <Tabs defaultValue="overview" className="w-full">
            <TabsList className="grid w-full grid-cols-6 bg-card/50 backdrop-blur-md border border-border/50">
            ...
            <TabsContent value="performance" className="space-y-6">
              <PerformanceMetrics showDetailed={true} className="max-w-4xl mx-auto" />
            </TabsContent>
            ...
            <TabsContent value="export" className="space-y-6">
              <DataExport
                data={topCoins.map(coin => ({
                  ...
                  riskScore: Math.floor(Math.random() * 100), // Replace with actual risk score
                  timestamp: new Date().toISOString(),
                  marketCap: coin.market_cap
                }))}
                className="max-w-4xl mx-auto"
                filename="crypto-dashboard-export"
              />
            </TabsContent>
